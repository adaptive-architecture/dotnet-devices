...
/// </summary>
/// <remarks>
/// Every entry point the driver calls is here,
/// so a test on any operating system can answer them: the two-call buffer protocol, the
/// structures the spooler writes into those buffers, and the Win32 error codes are all
/// logic this library owns, and none of it needs Windows to be exercised.
///
