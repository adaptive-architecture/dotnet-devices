...
public static class RasterCatalogue
{
    ...
    [
        ...
        new("anchored-bottom-left-with-an-offset", "A 4x6 label anchored bottom left on A4, inset 5 by 3 mm", "The placement a label uses. The sample label is smaller than the sheet, so it sits in the corner the anchor names at its own size and the offset insets it from there -- to the right, and up, which is what a negative vertical offset means. Measured on the media and not on the page.", 1),
